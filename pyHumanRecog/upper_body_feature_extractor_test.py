    ...
    for i in range(len(photos)):
        ...
        for j in range(len(photos[i].human_detections)):
            ...
            if count == batch_size:
                ...
                yield raw_img_data, upperbody_bbox, count
                raw_img_data= []
                upperbody_bbox = []
                count = 0
    if count != 0:
        ...
        for _ in range(batch_size - count):
            ...
            upperbody_bbox.append(upperbody_bbox[count-1])
        raw_img_data = np.array(raw_img_data)
        yield raw_img_data, upperbody_bbox, count
    return
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_load_dir', type=str, default='models/upperbody_model')
    parser.add_argument('--feature_dump_path', type=str, default='feat/upperbody.feat')
